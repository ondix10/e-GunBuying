    ...
    <section class="main-section contact" id="contact">
      ...
      <div class="row">  
        ...
        <div class="col-lg-12 wow fadeInUp delay-06s">
          <div class="form">
           <form action="<%= request.getContextPath()%>/ConfirmationCommande" method="post" enctype="multipart/form-data">
			...
			<p>QUANTITE* :</p>
			<input class="input-text animated wow flipInY delay-02s" type="text" name="a" value="" onFocus="if(this.value==this.defaultValue)this.value='';" onBlur="if(this.value=='')this.value=this.defaultValue;">
			<p>PERMIS DE CHASSE* (PDF) :</p>
			<input class="input-text animated wow flipInY delay-02s" type="file" name="doc" value="" onFocus="if(this.value==this.defaultValue)this.value='';" onBlur="if(this.value=='')this.value=this.defaultValue;">
